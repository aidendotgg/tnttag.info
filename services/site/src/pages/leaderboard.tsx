              ...
              <>
                <div className="flex flex-col gap-2 max-w-xl w-full">
                  <div className="flex flex-col relative w-full gap-2">
                    ...
                    >
                      <span className="mx-auto translate-x-3.5 font-bold text-xl">{formatWord(leaderboardName)}</span>
                  ...
                  <div className="h-fit rounded-md bg-neutral-950/80 p-4 border-1 border-neutral-950">
                    <h1 className="sm:text-2xl text-2xl font-bold text-center w-full">{formatWord(leaderboardName)} Leaderboard</h1>

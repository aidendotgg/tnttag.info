                ...
                <div className="flex min-[1160px]:flex-row flex-col gap-2">
                  <div className="flex min-[1270px]:flex-row flex-col gap-2">
                    <div className="flex flex-col gap-2 h-full">
                        ...
                        <div className="flex min-[830px]:w-fit w-full h-full flex-col rounded-md bg-neutral-950/80 p-4 border-1 border-neutral-950">
                          <div className="flex flex-col whitespace-nowrap">
                            ...
                            <div className="flex flex-col">
                              <h2 className="font-bold text-xl text-minecraft-white">Title Progress:</h2>
                              {formatWinMilestone(user!.wins)}
                            </div>
                            <p className="font-bold text-xl text-minecraft-white">
                            ...
                            <p className="font-bold text-xl text-minecraft-white">
                              Powerups: <span className="font-normal text-minecraft-gray">{user?.powerups.toLocaleString()}</span>{' '}
                              {user?.powerupsRank !== 0 && <LeaderNumber pos={user!.powerupsRank} />}
                            </p>
                            <p className="font-bold text-xl text-minecraft-white">
                      ...
                      <div className="flex min-[667px]:flex-row flex-col gap-2">
                        <div className="flex w-full flex-col rounded-md bg-neutral-950/80 p-4 border-1 border-neutral-950">
                          ...
                          <div className="flex flex-col whitespace-nowrap">
                            <p className="font-bold text-minecraft-white">
                              ...
                              {user?.twitter !== 'None' && (
                                <a href={user?.twitter} target="_blank">
                                  <svg className="h-5 w-5 fill-white" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <title>X</title>
                                    <path d="M14.234 10.162 22.977 0h-2.072l-7.591 8.824L7.251 0H.258l9.168 13.343L.258 24p.33l8.016-9.318L16.749 24h6.993zm-2.837 3.299-.929-1.329L3.076 1.56h3.182l5.965 8.532.929 1.329 7.754 11.09h-3.182z" />
                                  </svg>
                                </a>
                              )}
                              {user?.instagram !== 'None' && (
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex min-[1270px]:w-104 w-full h-full flex-col items-center rounded-md bg-neutral-950/80 p-4 border-1 border-neutral-950">
                        <h1 className="font-bold text-2xl mb-1 text-center text-minecraft-white text-nowrap">Unlocked Cosmetics</h1>
                        ...
                        <div className="grid min-[1270px]:grid-cols-2 min-[730px]:grid-cols-3 min-[440px]:grid-cols-2 grid-cols-1 gap-2 overflow-y-auto max-h-[262.5px] w-full">
                          {cosmeticValues.map((cosmetic, index) => (
                            <>
                              <div
                                className={`flex w-full flex-col rounded-md bg-neutral-900 p-2 border-1 ${cosmetic.unlocked ? 'border-minecraft-green' : 'border-minecraft-red'} `}
                                key={cosmetic.name + index}
                              >
                                <img src={`/icons/${cosmetic.name}.png`} className="flex h-14 w-14 mx-auto" />
                                <p className="text-center text-lg text-minecraft-white text-nowrap">{truncateString(formatCosmetic(cosmetic.name), 16)}</p>
                              </div>
                            </>
                          ))}
                        </div>
                      </div>
                      <div className="grid min-[440px]:grid-cols-2 grid-cols-1 gap-2 w-full h-full">
                        <div className="flex flex-col justify-center rounded-md bg-neutral-950/80 p-2 border-1 border-neutral-950">

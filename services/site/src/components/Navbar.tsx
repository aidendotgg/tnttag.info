                        ...
                        <div className="flex flex-row items-center">
                            <div onClick={() => router.push('/')} className="flex flex-row z-10 items-center hover:cursor-pointer pl-4 py-0.5">
                                ...
                                <h1 className="text-white text-2xl">
                                    <span className="text-minecraft-red">TNT</span>Tag.info
                                </h1>
                            </div>
                            <nav className="min-[900px]:flex hidden justify-center absolute w-full">
                                <ul className="flex flex-row gap-6">
                                    <li className="flex">
                                        <button className="text-white text-xl" onClick={() => router.push('/leaderboard')}>Leaderboard</button>
                                    </li>
                                    <li className="flex">
                                        <a className="text-white text-xl" href="https://github.com/aidendotgg/tnttagutilities" target="_blank">Proxy Mod</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
